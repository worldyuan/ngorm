...
var (
	// Epoch is set to the twitter snowflake epoch of 2022-02-11 05:08:35 UTC in milliseconds
	// You may customize this to set a different epoch for your application.
	Epoch int64 = 1644556115657
...
func (n *Node) GenerateByTimestamp(t int64) int64 {
	now := int64(time.Unix(t, 0).Nanosecond() / 1000000)
	if now < Epoch {
		now = 0
	}
	r := (now)<<n.timeShift
